...
from .const import CALC_METHODS, CONF_CALC_METHOD, DEFAULT_CALC_METHOD, DOMAIN, NAME, SCHOOL, CONF_SCHOOL, DEFAULT_SCHOOL
        ...
        options = {
            vol.Optional(
                ...
                default=self.config_entry.options.get(
                    CONF_CALC_METHOD, DEFAULT_CALC_METHOD, CONF_SCHOOL, DEFAULT_SCHOOL
                ),
            ): vol.In(CALC_METHODS, SCHOOL)
        }
