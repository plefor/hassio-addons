...
from .const import CONF_CALC_METHOD, DATA_UPDATED, DEFAULT_CALC_METHOD, DOMAIN, CONF_SCHOOL, DEFAULT_SCHOOL
...
class IslamicPrayerClient:
    ...
    async def async_add_options(self):
        ...
        if not self.config_entry.options:
            ...
            school = data.pop(CONF_SCHOOL, DEFAULT_SCHOOL)

            self.hass.config_entries.async_update_entry(
                self.config_entry, data=data, options={CONF_CALC_METHOD: calc_method, CONF_SCHOOL: school}
            )
